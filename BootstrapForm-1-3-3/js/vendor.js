(function(Array, String){
    ...
    if(!Array.prototype.containsAny){
        Array.prototype.containsAny = function(array){
            ...
            /*TODO make this more efficient (i.e. stop when found)*/
            return array.map(function(el){
                return original.includes(el);
    ...
    if(!String.prototype.equalsAny){
        String.prototype.equalsAny= function(array){
            'use strict';
            if(this == null){
                throw new TypeError('String.prototype.equalsAny called on null or undefined');
            }
            if (!Array.isArray(array)) {
                throw new TypeError();
            }
